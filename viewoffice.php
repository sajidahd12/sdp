...
if(isset($_GET['delid']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		echo "<script>window.location='viewoffice.php';</script>";
	}
}	
?>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">View Station</h3>
                    </div>
                            ...
                            <tbody>
                                ...
                                while ($rs = mysqli_fetch_array($qsql)) {
                                    echo "<tr>
                                        ...
                                        <td>$rs[status]</td>
                                        <td>
                                            <a href='Offices.php?editid=$rs[0]' class='btn btn-warning'>Edit</a>
                                            <a href='viewoffice.php?delid=$rs[0]' onclick='return confirmdel()' class='btn btn-danger'>Delete</a>
                                        </td>
                                    </tr>";
                                }
                                ?>
