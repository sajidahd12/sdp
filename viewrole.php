...
if(isset($_GET['delid']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		echo "<script>window.location='viewrole.php';</script>";
	}
}
?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-title">
                            <h1>View Roles and Resposibilities</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Officer Records</h3>
                    </div>
                    <div class="panel-body">
                        <table id="datatable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th><center><h5>Role Type</h5></center></th>
                                    <th><center><h5>Role Details</h5></center></th>
                                ...
                                while ($rs = mysqli_fetch_array($qsql)) {
                                    echo "<tr>
                                            ...
                                            <td style='width: 175px;'>
                                                <a href='role.php?editid=$rs[0]' class='btn btn-warning'>Edit</a>
                                                <a href='viewrole.php?delid=$rs[0]' onclick='return confirmdel()' class='btn btn-danger'>Delete</a>
                                            </td>
                                        </tr>";
                                }
                                ?>
