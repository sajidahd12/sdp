...
if(isset($_GET['delid']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		echo "<script>window.location='viewofficer.php';</script>";
	}
}
?>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                while ($rs = mysqli_fetch_array($qsql)) {
                                    ...
                                    } else if (file_exists('imgofficers/' . $rs['img'])) {
                                        $img = 'imgofficers/' . $rs['img'];
                                    } else {
                                        $img = "assets/images/No-Image-Available.png";
                                    }
                                    echo "<tr>
                                            ...
                                            <td>$rs[status]</td>
                                            <td>
                                                <a href='officer.php?editid=$rs[0]' class='btn btn-warning' style='width: 75px;'>Edit</a>
                                                <a href='viewofficer.php?delid=$rs[0]' onclick='return confirmdel()' class='btn btn-danger' style='width: 75px;'>Delete</a>
                                            </td>
                                        </tr>";
                                }
                                ?>
